...
//! define the threshold for the number of candidates required for Vy estimation (default: 2000)
#define VY_CAND_NUM_THLD (2000)
//! define the threshold for the number of candidates required for Linf estimation (default: 2000)
#define LINF_CAND_NUM_THLD (2000)
...
//! define the range for focal length in ratio in EDA optimization (default: 0.1f)
#define EDA_RNG_F (0.1f)
//! define the range for principal point coordinates in pixels in EDA optimization (default: 10)
#define EDA_RNG_PRIN_PT (10)
//! define the range for rotation angles in degrees in EDA optimization (default: 20.0)
#define EDA_RNG_ROT_ANG (20.0)
...
#define EDA_REPROJ_ERR_THLD (0.10)
